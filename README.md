...
The content for this project is generated by a large language model. The prompt used for generation can be found in [`docs/SEEDING_PROMPT.md`](/docs/SEEDING_PROMPT.md).
